    ...
    return (
        <div>
            ...
            <div className="model-box-view">
                <Modal show={ViewShow} onHide={hanldeViewClose} backdrop="static" keyboard={false}>
                    ...
                    <Modal.Body>
                        <div>
                            ...
                            {Delete && (
                                <Button type="submit" className="btn btn-danger mt-4" onClick={handleDelete}>
                                    Delete Employee
                                </Button>
                            )}
                        </div>
            ...
            <div className="model-box-view">
                <Modal show={ViewPost} onHide={hanldePostClose} backdrop="static" keyboard={false}>
                    <Modal.Header closeButton>
                    ...
                    <Modal.Body>
                        <div>
                            ...
                            <Button type="submit" className="btn btn-success mt-4" onClick={handleSubmite}>
                                Add Employee
                            </Button>
                        </div>
                    </Modal.Body>
            ...
            <div className="model-box-view">
                <Modal show={ViewEdit} onHide={hanldeEditClose} backdrop="static" keyboard={false}>
                    <Modal.Header closeButton>
